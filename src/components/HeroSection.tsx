...
function HeroSection() {
    return (
        <div className="md:h-[68rem] h-[48rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
            <Spotlight
                className=" md:left-[28rem] md:-top-20"
                fill="white"
            />
            <div className="p-4 relative z-10 text-center mt-10 md:-mt-5">
                <h1 className="mt-20 md:mt-0 text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                    AE TRADERS
                </h1>
                <p className="mt-7 font-normal text-base md:text-xl text-neutral-300 mx-auto px-4 md:px-4 xl:text-2xl">
